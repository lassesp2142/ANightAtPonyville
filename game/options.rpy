# A Night At Ponyville - options.rpy
...
init -1 python hide:
    ...
    ## This forces the main program window to be centered.  
    ...
    config.window_title = "A Night At Ponyville"

    ## This controls the icon of the window; when Ren'Py is running in
    ## a window.
    ...
    config.name = "ANightAtPonyville"
    config.version = "0.1 - Sweet Night"


    # This allows you to customize the pointer of the game.
    
    config.mouse = { 'default' : [ ('images/misc/cursor.png', 0, 0)] }
    ...
    theme.regal(
        ...
        mm_root = "images/screens/maintitlescreen.png",

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "images/screens/rootscreen.png",
    ...
    config.main_menu_music = "sounds/musics/main_theme.mp3"


    ## The amount of time in seconds to spend fading the old track out before a new music track starts. 
...
python early:
    config.save_directory = "PonyvilleNight-1445115788"
...
init python:
    ...
    build.directory_name = "A_Night_At_Ponyville-0.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "A_Night_At_Ponyville"
