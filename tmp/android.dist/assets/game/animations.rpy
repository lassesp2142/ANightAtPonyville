# A Night At Ponyville - animations.rpy
...
define quickdissolve =  Dissolve(.4) # The basic dissolve animation, but quicker.

define vqdissolve = Dissolve(0.2) # The basic dissolve animation, but a lot quicker.